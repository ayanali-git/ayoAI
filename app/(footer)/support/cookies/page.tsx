    ...
    <div className="py-12 sm:py-16 w-full max-w-3xl mx-auto min-w-0">
      ...
      <div className="space-y-8 sm:space-y-12 text-base sm:text-lg text-muted-foreground leading-relaxed">
        ...
        <section>
          ...
          <div className="space-y-6 mt-4 sm:mt-6">
            <div>
              ...
              <p className="text-base sm:text-base">Required for the website to function properly. These include authentication tokens, security measures, and load balancing cookies. You cannot opt out of these.</p>
            </div>
            
            <div>
              <h3 className="text-lg sm:text-xl font-medium text-foreground mb-1 sm:mb-2">Functional Cookies</h3>
              <p className="text-base sm:text-base">Allow us to remember your preferences and settings, such as your UI state or language preferences.</p>
            </div>

            <div>
              <h3 className="text-lg sm:text-xl font-medium text-foreground mb-1 sm:mb-2">Analytics Cookies</h3>
              <p className="text-base sm:text-base">Help us understand how visitors interact with our website by collecting and reporting information anonymously. We use this data to improve our services.</p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <button className="px-6 py-3 bg-secondary text-foreground font-medium rounded-full hover:bg-border transition-colors text-base sm:text-base">
            Manage Preferences
          </button>
        </section>
      </div>
