  ...
  return (
    <div className="min-h-screen bg-background">
      <main className="mx-auto max-w-3xl px-4 py-24 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-semibold tracking-tight text-foreground sm:text-5xl mb-6">Terms of Service</h1>
        ...
        <div className="space-y-12 text-lg text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">2. Acceptable Use Policy</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">3. Billing and Refunds</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">4. Termination</h2>
            <p>
