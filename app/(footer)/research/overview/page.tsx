...
export default function ResearchOverviewPage() {
  ...
  return (
    <div className="py-20 max-w-5xl mx-auto select-none">
      ...
      <div className="rounded-3xl border border-border/60 bg-gradient-to-br from-indigo-950/40 via-card to-background p-8 sm:p-12 mb-16 shadow-xl">
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between pb-4 border-b border-border/40">
          ...
          <span className="text-xs text-muted-foreground">Updated August 2026</span>
        </div>
          ...
          {researchPapers.map((paper, i) => (
            ...
            >
              <div className="flex items-center justify-between mb-3">
                <span className="text-[11px] font-semibold tracking-wider uppercase bg-secondary px-2.5 py-1 rounded-full text-foreground">
                  {paper.tag}
                </span>
              ...
              <p className="text-xs text-muted-foreground font-mono">{paper.authors}</p>
            </div>
          ))}
        </div>
      </div>
